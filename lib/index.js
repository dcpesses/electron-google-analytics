...
var Analytics = function () {
  ...
  _createClass(Analytics, [{
    ...
    value: function setcustomdimension(dimension, value) {
      this.customDimensions = Object.assign(this.customDimensions, _defineProperty({}, 'cd' + dimension, value));
    ...
    key: 'setcustommetric',
    value: function setcustommetric(metric, value) {
      this.customMetrics = Object.assign(this.customDimensions, _defineProperty({}, 'cd' + metric, value));
    ...
    value: function send(hitType, params, clientID) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (Object.keys(_this.customDimensions).length > 0) Object.assign(formObj, _this.customDimensions);
        if (Object.keys(_this.customMetrics).length > 0) Object.assign(formObj, _this.customMetrics);
