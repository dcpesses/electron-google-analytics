...
var Analytics = function () {
  ...
  _createClass(Analytics, [{
    ...
    value: function setcustomdimension(dimension, value) {
      this.customParams = Object.assign(this.customParams, _defineProperty({}, 'cd' + dimension, value));
      return this.customParams;
    }
    ...
    value: function setcustommetric(metric, value) {
      this.customParams = Object.assign(this.customParams, _defineProperty({}, 'cd' + metric, value));
      return this.customParams;
    }
    ...
    value: function send(hitType, params, clientID) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (Object.keys(_this.customParams).length > 0) Object.assign(formObj, _this.customParams);
